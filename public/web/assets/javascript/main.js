   ...
   var base_url = "{{ url('public/') }}";
	...
	var responsiveMenu = function() {
        ...
        $(window).on('load resize', function() {
            ...
            if ( currMenuType !== menuType ) {
                ...
                if ( currMenuType === 'mobile' ) {
                    var $mobileMenu = $('#navbarNav').attr('id', 'navbarNav-mobi').hide();
                    var hasChildMenu = $('#navbarNav-mobi').find('li:has(ul)');
                    ...
                    var $desktopMenu = $('#navbarNav-mobi').attr('id', 'navbarNav').removeAttr('style');
                    $('#navbarNav').find('li:has(ul)').children('ul').show();
        ...
        $('.btn-menu').on('click', function() {
            $('#navbarNav-mobi').slideToggle(300);
            $(this).toggleClass('active');
        });

        $(document).on('click', '#navbarNav-mobi li .btn-submenu', function(e) {
    ...
    //     if(retina) {
    //         $('.logo').find('img').attr({src:base_url+'web/assets/images/swagat.png',width:'131',height:'21'});
    //     }

    //     if(retina) {
    //         $('#logo-ft').find('img').attr({src:base_url+'web/assets/images/swagat.png',width:'133',height:'21'});
    //     }
    // };
